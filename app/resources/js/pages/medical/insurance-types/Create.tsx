...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Crear',
    href: '/medical/insurance-types/create',
  },
]

export default function InsuranceTypesCreate() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post('/medical/insurance-types', {
      preserveScroll: true,
      onSuccess: () => {
        toast.success('Tipo de seguro creado correctamente')
      },
      onError: () => {
        toast.error('Error al crear el tipo de seguro')
      },
    })
  }
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Crear Tipo de Seguro - Sistema Médico" />

      <div className="space-y-6">
        <HeadingSmall
          title="Crear Tipo de Seguro"
          description="Registrar un nuevo tipo de seguro médico"
        />
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end space-x-4 pt-6 border-t">
                ...
                >
                  {processing ? 'Creando...' : 'Crear Tipo de Seguro'}
                </Button>
              </div>
            </form>
          </CardContent>
