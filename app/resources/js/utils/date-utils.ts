...
/**
 * Format a date in the standard system format for Paraguay UI.
 * Format: "dd-mm-yyyy".
 */
...
/**
 * Convert a UI date string "dd-mm-yyyy" into a backend-friendly
 * date string "yyyy-mm-dd".
 */
export function formatSystemDateForBackend(
...
/**
 * Format a datetime string in the standard system format for Paraguay UI.
 * Format: "dd-mm-yyyy HH:mm" using 24-hour time.
 */
...
/**
 * Convert a UI datetime string "dd-mm-yyyy HH:mm" into a backend-friendly
 * datetime string "yyyy-mm-dd HH:mm:ss".
 */
export function formatSystemDateTimeForBackend(
    value: string | null | undefined,
): string {
    if (!value) return '';
